                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="mt-auto pt-2">
                            <router-link :to="`/profile/${profile.id}`"
                                class="inline-flex items-center justify-center w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-5 py-2.5 rounded-lg font-medium shadow-sm transition-all">
                                Xem chi tiết
