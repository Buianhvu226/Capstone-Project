<template>
  <form @submit.prevent="handleSubmit" class="space-y-6">
    ...
    <div class="group">
      <label for="password"
        class="block text-sm font-medium text-gray-700 mb-1 transition-all group-focus-within:text-primary-600">Mật khẩu</label>
      <div class="relative">
        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
    ...
    <div>
      <button type="submit"
        class="w-full btn btn-primary py-3 flex justify-center items-center transition-all duration-300 transform hover:translate-y-[-2px] hover:shadow-lg"
        :disabled="loading">
