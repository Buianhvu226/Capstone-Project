<template>
  <div class="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-blue-50 via-blue-50 to-blue-100">
    ...
    <div class="flex flex-col items-center justify-center w-full lg:w-[480px] px-4 py-12 bg-white relative z-10">
