<template>
    <div class="messages-view min-h-screen bg-gray-50">
        <AppHeader />
        <div class="container mx-auto px-2 sm:px-4 py-5 pt-16 md:pt-20">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                <div class="flex flex-col sm:flex-row h-[80vh] md:h-[70vh] lg:h-[75vh]">
